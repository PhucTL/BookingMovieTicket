...
{
    /// <summary>
    /// Phát thông báo real-time qua SignalR khi có ghế vừa được giữ tạm thời
    /// </summary>
    Task NotifySeatsHeldAsync(Guid showtimeId, Guid heldByUserId, DateTime heldUntil, IEnumerable<ShowtimeSeat> seats);

    /// <summary>
    /// Phát thông báo real-time qua SignalR khi có ghế vừa được nhả/giải phóng
    /// </summary>
    Task NotifySeatsReleasedAsync(Guid showtimeId, IEnumerable<ShowtimeSeat> seats);

    /// <summary>
    /// Phát thông báo real-time qua SignalR khi có ghế đã được thanh toán và bán thành công
    /// </summary>
